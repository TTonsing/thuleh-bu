        ...
        <?php } else { ?>
            <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                <table class='wp-list-table widefat fixed'>
					...
					<tr width="20%" >
					<th width="5%">Definition</th><td width="60%"><input readonly="readonly" type="text" name="definition" value="<?php echo $rowG->definition; ?>" maxlength="200" size="150"  rows="2"/></td></tr>
					<tr width="20%" rowspan="5">
					<?php if (!empty($row->Paite)){ ?>
					<th width="5%">Paite</th><td width="60%"><input readonly="readonly" type="textarea" name="Paite" value="<?php echo $rowG->Paite; ?>" maxlength="200" size="150"  rows="2"/></td></tr>
					<?php }else{ ?>
					<th width="5%">Paite</th><td width="60%"><input type="textarea" name="Paite" value="<?php echo $rowG->Paite; ?>" maxlength="200" size="150"  rows="2"/></td></tr>
					<?php }?>
                </table>
